...
function Project() {
  ...
  return (
    <div className='card-container d-flex flex-wrap justify-content-around flex-wrap'>
    {projInfo.map((project) => (
          <div className='card m-3 mx-5 p-3 flex-grow-1' id='card-styling' key={project.name}>
